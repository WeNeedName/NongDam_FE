...
const EditMemberInfo = () => {
  ...
  console.log("기존 작물 리스트", cropsArray);
  console.log("새로 선택한 작물 리스트 ", cropsObj);
...
//     // const newCropSet = [];
//     if (!sendCrops) {
//       const newCropSet = cropsArray?.filter(
//         (list) => Number(list.value) !== Number(id)
//       );
//       setSendCrops(newCropSet);
//     } else {
//       const newCropSet = sendCrops?.filter(
//         (list) => Number(list.value) !== Number(id)
//       );
//       setSendCrops(newCropSet);
//     }
...
//   console.log(cropsArray, sendCropsFilter, cropsArrayFilter);
...
//         countryCode:
//           countryCode === undefined ? previousCountryCodeNumber : countryCode,
//         crops: sendCrops !== undefined ? sendCropsFilter : cropsArrayFilter,
//       };
//       let frm = new FormData();
//       frm.append("data", JSON.stringify(data));
//       if (profileImg === "") {
