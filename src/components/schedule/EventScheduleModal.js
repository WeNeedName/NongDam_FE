...
const EventScheduleModal = ({
  ...
  const eventInfoStartTime = moment(eventInfo.start).format("YY년 MM월 DD일 HH시MM분");
  const eventInfoEndTime = moment(eventInfo.end).format("YY년 MM월 DD일 HH시MM분")
  return(
    <>
    <StyledModal
      isOpen={isOpen}
      ...
      <TotalTitle>일정확인 </TotalTitle>
        <Wrap>
            <CropWrap>
              ...
              <Content>{eventInfo.crop}</Content>
            </CropWrap>
            <WorkWrap>
          ...
          <TimeWrap>
            ...
            <TimeContentWrap>
              ...
              <TimeContent>
                <TimeTitle> 종료일</TimeTitle>{eventInfoEndTime}
              </TimeContent>
            </TimeContentWrap>
          </TimeWrap>
        </Wrap>
